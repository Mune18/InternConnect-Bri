...
export class AuthService {
  ...
  // http://127.0.0.1:8000/api/register/intern
...
InternOrRecruiter(role: string) {
  if (role === 'intern') {
    this.router.navigateByUrl('/homepage-intern'); // Adjust this path as per your routes
  } else if (role === 'recruiter') {
    this.router.navigateByUrl('/homepage-recruiter'); // Adjust this path as per your routes
  } else {
